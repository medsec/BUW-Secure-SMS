...
/**
 * These are the QR-code contents. Tis class is just a container to store all data.
 * @author Paul Kramer
 *
 */
public final class Contents {
    ...
    /**
     * This class stores some types of the QR-code communication protocol. They are used by the Contents class.
     * @author Paul Kramer
     *
     */
